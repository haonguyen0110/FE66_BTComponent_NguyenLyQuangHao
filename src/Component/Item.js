                        ...
                        <div className="col-lg-4 col-xxl-4 mb-5">
                            <div className="card bg-light border-0 h-100">
                                <div className="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                    <div className=" rounded-3 mb-4 mt-n4 d-flex justify-content-center align-items-center"><i className="bi bi-collection feature bg-primary bg-gradient text-white" /></div>
